...
<div class="card-dark px-8 py-[34px]">
    ...
    <div class="relative z-[2]">
        <span class="eyebrow text-white/50">{{ $credit['active'] ? 'Approved purchase limit' : 'Purchase limit' }}</span>
        ...
        <div class="mt-6">
            ...
            <div class="flex justify-between font-mono text-[10.5px] tracking-[.08em] uppercase text-white/50 mt-2"><span>Used</span><span>Available</span></div>
        </div>
        <p class="text-[11.5px] text-white/40 mt-[18px] leading-normal">
