        ...
        >
            ...
            <div class="relative z-[2]">
                ...
                <div class="grid md:grid-cols-2 gap-7 mt-8 items-start">
                    <div>
                        <div class="mb-[18px]">
                            <label for="calc-price" class="field-label text-white/70">Product price (PKR)</label>
                        ...
                        <div class="mb-[18px]">
                            <label for="calc-months" class="field-label text-white/70">Instalment term</label>
                    ...
                    <div class="p-5 rounded-2xl bg-white/[.06] border border-white/[.13]">
                        ...
                        <div class="font-mono text-[10.5px] tracking-[.12em] uppercase text-white/70 mt-1.5">Estimated per month</div>
                ...
                <p class="text-[11.5px] text-white/65 mt-4 leading-normal">
