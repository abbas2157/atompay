...
class KycApplicationRequest extends FormRequest
{
    public function rules(): array
    {
        ...
        return [
            ...
            'cnic'                => ['required', 'digits:13', Rule::unique('atompay_kyc_profiles', 'cnic')->ignore($this->user()->id, 'user_id')],
            'mobile'              => ['required', 'string', 'max:20', 'regex:/^(\+92|0)?3\d{9}$/'],
    ...
    {
        return [
            'cnic.digits'         => 'Enter the 13 digits of your CNIC without dashes.',
            'mobile.regex'        => 'Enter a Pakistani mobile number, e.g. 03001234567.',
